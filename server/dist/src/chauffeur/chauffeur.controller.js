...
exports.ChauffeurController = void 0;
const common_1 = require("@nestjs/common");
const chauffeur_service_1 = require("./chauffeur.service");
const jwt_auth_guard_1 = require("../auth/jwt-auth.guard");
const roles_guard_1 = require("../auth/roles.guard");
const roles_decorator_1 = require("../auth/roles.decorator");
let ChauffeurController = class ChauffeurController {
    chauffeurService;
    constructor(chauffeurService) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", void 0)
], ChauffeurController.prototype, "remove", null);
exports.ChauffeurController = ChauffeurController = __decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, common_1.Controller)('chauffeurs'),
    __metadata("design:paramtypes", [chauffeur_service_1.ChauffeurService])
], ChauffeurController);
